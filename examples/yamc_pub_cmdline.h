...
#ifndef YAMC_PUB_CMDLINE_H
#define YAMC_PUB_CMDLINE_H
...
#ifndef YAMC_PUB_CMD_PARSER_PACKAGE
/** @brief the program name (used for printing errors) */
#define YAMC_PUB_CMD_PARSER_PACKAGE "yamc_pub"
#endif

#ifndef YAMC_PUB_CMD_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define YAMC_PUB_CMD_PARSER_PACKAGE_NAME "yamc_pub"
#endif

#ifndef YAMC_PUB_CMD_PARSER_VERSION
/** @brief the program version */
#define YAMC_PUB_CMD_PARSER_VERSION "1.0.0"
#endif

/** @brief Where the command line options are stored */
struct yamc_pub_args_info
{
  ...
  char * topic_arg;	/**< @brief MQTT topic to publish message to..  */
  char * topic_orig;	/**< @brief MQTT topic to publish message to. original value given at command line.  */
  const char *topic_help; /**< @brief MQTT topic to publish message to. help description.  */
  char * message_arg;	/**< @brief MQTT message to publish..  */
  char * message_orig;	/**< @brief MQTT message to publish. original value given at command line.  */
  const char *message_help; /**< @brief MQTT message to publish. help description.  */
...
struct yamc_pub_cmd_parser_params
{
  ...
  int initialize; /**< @brief whether to initialize the option structure yamc_pub_args_info (default 1) */
  int check_required; /**< @brief whether to check that all required options were provided (default 1) */
  int check_ambiguity; /**< @brief whether to check for options already specified in the option structure yamc_pub_args_info (default 0) */
  int print_errors; /**< @brief whether getopt_long should print an error message for a bad option (default 1) */
} ;

/** @brief the purpose string of the program */
extern const char *yamc_pub_args_info_purpose;
/** @brief the usage string of the program */
extern const char *yamc_pub_args_info_usage;
/** @brief the description string of the program */
extern const char *yamc_pub_args_info_description;
/** @brief all the lines making the help output */
extern const char *yamc_pub_args_info_help[];
 ...
 */
int yamc_pub_cmd_parser (int argc, char **argv,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 * @deprecated use yamc_pub_cmd_parser_ext() instead
 */
int yamc_pub_cmd_parser2 (int argc, char **argv,
  struct yamc_pub_args_info *args_info,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int yamc_pub_cmd_parser_ext (int argc, char **argv,
  struct yamc_pub_args_info *args_info,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int yamc_pub_cmd_parser_dump(FILE *outfile,
  struct yamc_pub_args_info *args_info);
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int yamc_pub_cmd_parser_file_save(const char *filename,
  struct yamc_pub_args_info *args_info);

/**
 * Print the help
 */
void yamc_pub_cmd_parser_print_help(void);
/**
 * Print the version
 */
void yamc_pub_cmd_parser_print_version(void);

/**
 * Initializes all the fields a yamc_pub_cmd_parser_params structure 
 * to their default values
 * @param params the structure to initialize
 */
void yamc_pub_cmd_parser_params_init(struct yamc_pub_cmd_parser_params *params);

/**
 * Allocates dynamically a yamc_pub_cmd_parser_params structure and initializes
 * all its fields to their default values
 * @return the created and initialized yamc_pub_cmd_parser_params structure
 */
struct yamc_pub_cmd_parser_params *yamc_pub_cmd_parser_params_create(void);

/**
 * Initializes the passed yamc_pub_args_info structure's fields
 * (also set default values for options that have a default)
 * @param args_info the structure to initialize
 */
void yamc_pub_cmd_parser_init (struct yamc_pub_args_info *args_info);
/**
 * Deallocates the string fields of the yamc_pub_args_info structure
 * (but does not deallocate the structure itself)
 * @param args_info the structure to deallocate
 */
void yamc_pub_cmd_parser_free (struct yamc_pub_args_info *args_info);
 ...
 * @return
 */
int yamc_pub_cmd_parser_required (struct yamc_pub_args_info *args_info,
  const char *prog_name);

extern const char *yamc_pub_cmd_parser_qos_values[];  /**< @brief Possible values for qos. */
extern const char *yamc_pub_cmd_parser_will_qos_values[];  /**< @brief Possible values for will-qos. */


#ifdef __cplusplus
}
#endif /* __cplusplus */
#endif /* YAMC_PUB_CMDLINE_H */
